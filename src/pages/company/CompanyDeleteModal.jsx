...
import { deleteCompany } from '../../api/company.js'
import { parseApiError } from '../../api/errors.js'

const DELETE_MODAL_ID = 'company-delete-modal'

const deleteSchema = z.object({
  password: z.string().min(1, 'পাসওয়ার্ড দিন'),
})

export const CompanyDeleteModal = forwardRef(function CompanyDeleteModal(
  { company, onDeleted, onError },
  ref,
) {
  const dialogRef = useRef(null)

  const deleteMutation = useMutation({
    mutationFn: (password) => deleteCompany({ password }),
  })
    ...
    >
      <div className="modal-box max-w-sm max-h-[min(32rem,85vh)] flex flex-col">
        ...
        <p className="text-sm text-base-content/70 mb-3 shrink-0">
          কোম্পানির সব রেকর্ড এবং আপনার একাউন্ট ডিলিট হয়ে যাবে। ডিলিট করা কোম্পানি পুনরায় ফিরিয়ে আনা যাবে না। নিশ্চিত করতে আপনার
          পাসওয়ার্ড দিন।
        </p>
