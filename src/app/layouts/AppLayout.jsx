...
/** Users nav always shown for now — PermissionGate later. */
const bottomNav = [
  { to: '/sites', label: 'সাইট', icon: MapPin },
  { to: '/labours', label: 'শ্রমিক', icon: HardHat },
  { to: '/users', label: 'ইউজার', icon: Users },
  { to: '/profile', label: 'প্রোফাইল', icon: UserCircle },
]
